CoolClock.config.skins = {
   ...
   vanilla: {
		outerBorder: { lineWidth: 4, radius:97, color: "#1E79A7", fillColor: "#E3F4FF", alpha: 1 },
		smallIndicator: { lineWidth: 3, startAt: 91, endAt: 97, color: "#1E79A7", alpha: 1 },
		largeIndicator: { lineWidth: 5, startAt: 85, endAt: 97, color: "#1E79A7", alpha: 1 },
		hourHand: { lineWidth: 5, startAt: -15, endAt: 50, color: "#1E79A7", alpha: 1 },
		minuteHand: { lineWidth: 3, startAt: -15, endAt: 75, color: "#1E79A7", alpha: 1 },
		secondHand: { lineWidth: 1, startAt: -20, endAt: 85, color: "red", alpha: 1 }
	},
};